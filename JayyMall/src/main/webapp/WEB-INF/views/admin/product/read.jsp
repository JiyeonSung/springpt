						...
						<div class="box box-primary">
							...
							<div class="box-body">
								<div class="form-group">
									...
									<span class="form-control" style="width:40%; margin-right:10px; display:inline-block;">${vo.cat_parcode}</span>
									<span class="form-control" style="width:40%;  display:inline-block;">${vo.cat_code}</span>
									
								</div>
								<div class="form-group">
									<label for="exampleInputEmail1">Product Name</label> 
									<span class="form-control">${vo.product_name}</span>
								</div>
								<div class="form-group">
									<label for="exampleInputEmail1">Company</label> 
									<span class="form-control">${vo.product_company}</span>
								</div>
								<div class="form-group">
									...
									<span class="form-control" style="width:40%; margin-right:10px; display:inline-block;">${vo.product_price}</span>
									<span class="form-control" style="width:40%; display:inline-block;">${vo.product_discount}</span>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<span class="form-control"><c:out value="${vo.product_img}" /></span>
									<!-- TODO: 이미지파일 처리 필요 -->
									<!-- 
									<input
								...
								<div class="form-group">
									...
									<span class="form-control" style="width:40%; margin-right:10px; display:inline-block;">${vo.product_amount}</span>
									<span class="form-control" style="width:40%; display:inline-block;">${vo.product_buy}</span>
								</div>
								<div class="form-group">
									...
									<!-- 
									<input type="text" id="product_update" name="product_update" class="form-control" 
										value="${vo.product_update}" readonly />
										 -->
								</div>
							</div>
