				...
				<div style="width:100%; min-width:1400px; background-color:white; padding: 50px 180px;" class="container text-center">
					...
					<ul class="pdtList">
						...
						<li class="product">
							...
							<div class="thumnail">
								<a href="/product/readSearch${pm.makeSearch(pm.cri.page)}&product_num=${productVO.product_num}">
									<img src="/product/displayFile?fileName=${productVO.product_img}" >
								</a>
							</div>
							<div class="description">
								<a href="/product/readSearch${pm.makeSearch(pm.cri.page)}&product_num=${productVO.product_num}" >${productVO.product_name}</a>
