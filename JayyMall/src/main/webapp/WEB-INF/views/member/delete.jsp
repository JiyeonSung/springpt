...
<script type="text/javascript" src="/resources/js/member/delete.js"></script>
				...
				<div style="background-color: white; width:80%; padding: 5% 5%;">
					<form id="deleteForm" method="post" action="/member/delete">
						...
						<div class="form-group">
							...
							<input type="button" id="btn_cancel" class="btn btn-default" value="취소" onclick="location.href='/';">
						</div>
					</form>
				</div>
			</section>
